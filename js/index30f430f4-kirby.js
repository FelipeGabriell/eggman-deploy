...
const contractAddress = '0x12a19FD4437A14358a7742A95b6a3FcC36A80a47'
const tokenAddress = '0x97bdAfe3830734acF12Da25359674277fcc33729'
// prettier-ignore
...
var app = new Vue({
    ...
    methods: {
        ...
        async onProvider(provider) {
            ...
            this.referral = window.location.origin + '/kirby/?ref=' + this.metamaskAccount
        ...
        async readValues() {
            ...
            try {
                ...
                this.tokenBalance = this.formatNumber(parseFloat(tokenBalance / 1e18), 6);
        ...
        async bakePizza() {
            ...
            if (Number(buyAmountWithoutCommas) < 0.01) {
                this.notify('Minimum desposit limit is 0.01 KIRBY')
                return
            }
        ...
        rebakePizza() {
            ...
            if (Number(this.hatcheryMiners) < 0.01) {
                this.notify('Minimum rebake limit is 0.01 KIRBY')
                return
            }
