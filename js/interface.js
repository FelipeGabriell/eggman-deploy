var minersAddr = '0xefa599908c48bbCF605B374B9BC0513BA8C2d54c';
var tokenAddr = '0x8050bc51D00a2Ad1d42f018Ae1A27c8C5b433810';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " EGGMAN in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + trx + " EGGMAN first");
	} else {
